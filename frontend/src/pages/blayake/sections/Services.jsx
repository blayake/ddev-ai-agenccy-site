...
function PreviewCard({ active, x, y }) {
  ...
  return (
    <motion.div
      ...
      transition={{ duration: 0.4, ease: [0.22, 1, 0.36, 1] }}
      className="pointer-events-none absolute top-0 left-0 w-44 aspect-[4/5] rounded-xl overflow-hidden hidden lg:block z-20 shadow-[0_24px_50px_rgba(0,0,0,0.6)] ring-1 ring-white/10"
    >
      {SERVICES.map((s, i) => (
        <motion.img
          key={s.n}
